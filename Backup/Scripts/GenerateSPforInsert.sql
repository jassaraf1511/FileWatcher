IF OBJECT_ID('GenerateSPforInsert','P') IS NOT NULL
	DROP PROC GenerateSPforInsert
GO

CREATE PROC GenerateSPforInsert
...
---print @columnNamesWithDatatypes
--print len(@columnNamesWithDatatypes)
...
SELECT @InsertSQL = 'INSERT INTO ' + @Schemaname +'.' + @Tablename 
 ...
 IF LTRIM(RTRIM(@ProcName)) = '' 
	SELECT @ProcName = 'SP_Insert_' + @Tablename
